...
{
    @Query(value = "SELECT t.todoid, t.description, t.completed, u.username FROM todo t, users u WHERE t.userid = u.userid", nativeQuery = true)
    List<Object[]> todosWithUsers();
